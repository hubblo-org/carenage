...
BEGIN
	...
	INSERT INTO EVENTS (project_id, workflow_id, pipeline_id, job_id, run_id, task_id, device_id, event_type) VALUES (p_id, w_id, pip_id, j_id, r_id, t_id, d_id, 'regular') RETURNING id INTO e_id; 
        RETURN e_id;	
END
$BODY$;
